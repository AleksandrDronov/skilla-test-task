...
const fsdPublicApi = {
  ...
  '@/features/paginate-calls': path.join(src, 'features/paginate-calls/index.ts'),
  '@/features/calls-table': path.join(src, 'features/calls-table/index.ts'),
  '@/widgets/calls-page-table': path.join(src, 'widgets/calls-page-table/index.ts'),
  '@/widgets/calls-page-toolbar': path.join(src, 'widgets/calls-page-toolbar/index.ts'),
