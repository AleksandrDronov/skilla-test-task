...
import { formatCallDuration, formatCallTime, formatPhoneNumber } from '../../../shared/utils/formatters'
...
export const CallRow = ({ call, activeRecordId, loadingRecordId, onToggleRecord, onDownloadRecord }: CallRowProps) => {
